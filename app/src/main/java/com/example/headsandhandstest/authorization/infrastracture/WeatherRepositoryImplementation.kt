...
class WeatherRepositoryImplementation(
    ...
    override suspend fun get(): Weather =
        weatherConverter.fromDto(
    ...
    private fun parseResponse(response: String): WeatherDto {
        return gson.fromJson(response, WeatherDto::class.java)
    }
}